...
export const metadata: Metadata = {
  title: "Johnny Sins - Professional Fitness Coach & Trainer",
  description: "Transform your body and mind with Johnny Sins' proven fitness programs, nutrition coaching, and professional training services. Get results that last.",
  keywords: "fitness coach, personal trainer, nutrition coaching, workout programs, fitness transformation, Johnny Sins",
  metadataBase: new URL("https://johnnysins.fitness"),
  alternates: {
    canonical: "https://johnnysins.fitness"
  },
  openGraph: {
    title: "Johnny Sins - Professional Fitness Coach & Trainer",
    description: "Transform your body and mind with proven fitness programs and professional coaching",
    url: "https://johnnysins.fitness",
    siteName: "Johnny Sins Fitness",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35Znpd3ByEERAsUQupIuQAIsKDh/uploaded-1763681989768-rd9njsir.jpg",
        alt: "Johnny Sins professional fitness trainer"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Johnny Sins - Professional Fitness Coach",
    description: "Transform your body and mind with proven fitness programs",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35Znpd3ByEERAsUQupIuQAIsKDh/uploaded-1763681989768-rd9njsir.jpg"]
  },
  robots: {
    index: true,
    follow: true
